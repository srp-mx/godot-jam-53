...
public partial class Machine : Node
{
    ...
    private void initInstructions()
    {
        ...
        instructions.Add(new("RET", 3, 0, RET), InstructionSets.Available.Control);
        instructions.Add(new("CALL", 4, 1, CALL), InstructionSets.Available.Control);
        instructions.Add(new("PRINT", 5, 1, PRINT), InstructionSets.Available.Debug);
        instructions.Add(new("NOP", 6, 0, NOP), InstructionSets.Available.Basic);
        instructions.Add(new("MOV", 7, 2, MOV), InstructionSets.Available.Memory);
        instructions.Add(new("ADD", 8, 2, ADD), InstructionSets.Available.Math);
        instructions.Add(new("NEG", 9, 1, NEG), InstructionSets.Available.Math);
        instructions.Add(new("CMP", 10, 2, CMP), InstructionSets.Available.Decision);
        instructions.Add(new("JMPF", 11, 2, JMPF), InstructionSets.Available.Decision);
        instructions.Add(new("JMPNF", 12, 2, JMPNF), InstructionSets.Available.Decision);
        instructions.Add(new("INC", 13, 1, INC), InstructionSets.Available.Math);
        instructions.Add(new("DEC", 14, 1, DEC), InstructionSets.Available.Math);
        instructions.Add(new("JMP", 15, 1, JMP), InstructionSets.Available.Control);
        instructions.Add(new("ROT_CLOCK", 16, 1, ROT_CLOCK), InstructionSets.Available.BasicMovement);
        instructions.Add(new("ROT_ANTI", 17, 1, ROT_ANTI), InstructionSets.Available.BasicMovement);
        instructions.Add(new("INTERACT", 18, 0, INTERACT), InstructionSets.Available.Basic);
        instructions.Add(new("MOV_R", 19, 1, MOV_R), InstructionSets.Available.MidMovement);
        instructions.Add(new("MOV_L", 20, 1, MOV_L), InstructionSets.Available.MidMovement);
        instructions.Add(new("MOV_F", 21, 1, MOV_F), InstructionSets.Available.BasicMovement);
        instructions.Add(new("MOV_B", 22, 1, MOV_B), InstructionSets.Available.MidMovement);
        instructions.Add(new("JUMP_UP", 23, 1, JUMP_UP), InstructionSets.Available.MidMovement);
        instructions.Add(new("FLY_UP", 24, 1, FLY_UP), InstructionSets.Available.AdvancedMovement);
        instructions.Add(new("FLY_DOWN", 25, 1, FLY_DOWN), InstructionSets.Available.AdvancedMovement);
        instructions.Add(new("FALL", 26, 0, FALL), InstructionSets.Available.AdvancedMovement);
        instructions.Add(new("CMPKEY", 27, 1, CMPKEY), InstructionSets.Available.Input);
        instructions.Add(new("SHOOT", 28, 0, SHOOT), InstructionSets.Available.Final);
        instructions.Add(new("RELOAD", 29, 0, RELOAD), InstructionSets.Available.Final);
        instructions.Add(new("COOL", 30, 0, COOL), InstructionSets.Available.Final);
        instructions.Add(new("PUSH", 31, 1, PUSH), InstructionSets.Available.Memory);
        instructions.Add(new("POP", 32, 1, POP), InstructionSets.Available.Memory);
        instructions.Add(new("CALLF", 33, 2, CALLF), InstructionSets.Available.AdvancedDecision);
        instructions.Add(new("CALLNF", 34, 2, CALLNF), InstructionSets.Available.AdvancedDecision);
    }
